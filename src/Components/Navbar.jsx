...
import flipkarImg from "./images/flipkart.svg";
import groceryImg from "./images/grocery img.png";
import mobileImg from "./images/mobile img.png";
import fashionImg from "./images/fashion img.png";
import electronicsImg from "./images/electronics img.png";
import furnitureImg from "./images/furniture.jpg";
import AppliancesImg from "./images/Appliances.jpg";
import beautyImg from "./images/beauty img.png";
import vehicleImg from "./images/vehicle img.png";
import fragnenceImg from "./images/fragnence img.png";
 ...
 const handleCartClick= ()=>{
  ...
  return (
    ...
    <>
          ...
          <div className="header">
            ...
            <div className="navRight">
              <div className="loginMain">
                ...
                <div className="logOutText">{getUser.name}</div>
                </button>
                }
              </div>
        ...
        <div className="category_headerMain" >
